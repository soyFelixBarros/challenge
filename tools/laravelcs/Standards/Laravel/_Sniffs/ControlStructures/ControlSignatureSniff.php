...
*/
class LaravelSniffsControlStructuresControlSignatureSniff implements Sniff
{
	/**
	...
	public function process(File $phpcsFile, $stackPtr)
	{
		...
		{
			$found = 0;
		} else if ( ! in_array($tokens[($stackPtr + 1)]['content'], [' ', $phpcsFile->eolChar]))
		{
		...
		{
			$found = 0;
		} else if ( ! in_array($tokens[($closer + 1)]['content'], [' ', $phpcsFile->eolChar]))
		{
			if (strpos($tokens[($closer + 1)]['content'], $phpcsFile->eolChar) !== false)
			{
				$found = 'newline';
